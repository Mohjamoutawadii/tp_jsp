...
@WebServlet(name = "ActivationController", urlPatterns = {"/mdpOublie"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Client c : clients) {
            if (email.equals(c.getEmail()) && a) {
                ...
                EmailSender.sendEmail(email, "Code de Recuperation", code);
        ...
        if (a) {
            ...
            request.getRequestDispatcher("mdpOublie.jsp").forward(request, response);
